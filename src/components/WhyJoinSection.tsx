...
export default function WhyJoinSection() {
  ...
  return (
    <div
      id="why-join-section"
      ref={sectionRef}
      className="section-container w-full overflow-hidden py-20 md:py-28"
    >
      {/* Section heading */}
      ...
      <div className="space-y-28 md:space-y-36 w-full">
        {FEATURES.map((feature) => {
          ...
          return (
            ...
            >
              ...
              >
                {/* Number badge */}
                <span className="inline-block text-7xl md:text-8xl font-black text-primary/15 dark:text-primary/20 leading-none mb-4 select-none">
                  0{feature.id}
                </span>
                <h3 className="text-3xl md:text-4xl font-bold mb-6 leading-tight">
                  {feature.title}
                </h3>
                <p className="text-muted-foreground text-balance leading-relaxed text-lg md:text-xl">
                  {feature.description}
                </p>
              </div>
            </div>

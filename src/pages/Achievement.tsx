                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {studentData.map((item) => (
                                <Card
                                    key={item.id}
                                    className="group overflow-hidden border border-border/60 hover:border-blue-400/50 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 bg-card"
                                >
                        ...
                        {filteredAwards.length === 0 ? (
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                {filteredAwards.map((award) => (
                                    <div
                                        key={award.id}
                                        className="group glass rounded-xl overflow-hidden border border-border/60 hover:border-amber-400/50 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1"
                                    >
